...
;	.asg 0x28, CTPPR0                               ; page 75
	...
	;.asg 0x20800000, ADC_TSC_STEPCONFIG_1_MASK            ; SW mode, differential pair enable, one shot mode, fifo 0, ch0_positivo - ch1_negativo
        ...
        .asg 0xC6, ADC_TSC_STEPCONFIG_2                 ; ch1
        .asg 0x00, ADC_TSC_STEPCONFIG_2_MASK            ; SW mode, single ended, one shot mode, fifo 0, channel 0
        .asg 0x70, ADC_TSC_STEPDELAY_2                  ; TRM pag. 1859
        .asg 0x00, ADC_TSC_STEPDELAY_2_MASK             ; OpenDly0 SampleDly0

        .asg 0x74, ADC_TSC_STEPCONFIG_3                 ; ch2
        .asg 0x78, ADC_TSC_STEPCONFIG_3_MASK            ; SW mode, single ended, one shot mode, fifo 0, channel 0
        .asg 0x70, ADC_TSC_STEPDELAY_3                  ; TRM pag. 1859
        .asg 0x00, ADC_TSC_STEPDELAY_3_MASK             ; OpenDly0 SampleDly0

        .asg 0x7C, ADC_TSC_STEPCONFIG_4                 ; ch3
        .asg 0x80, ADC_TSC_STEPCONFIG_4_MASK            ; SW mode, single ended, one shot mode, fifo 0, channel 0
        .asg 0x70, ADC_TSC_STEPDELAY_4                  ; TRM pag. 1859
        ...
        .asg 0x1E, ADC_TSC_STEPENABLE_ENABLE_MASK	; Se habilitan los cuatro primeros canales (0001 1110)
...
; inicializacion de shared mem
	...
	LDI32	r5, ram0_addr				; no usar este registro para otra cosa cananl 0
...
; Step 1 config Importante STEPCONFIG_PROTECT debe ser SET para configurar STEP
...
; Step 2 config Importante STEPCONFIG_PROTECT debe ser SET para configurar STEP
        LDI32   r0, (ADC_TSC | ADC_TSC_STEPCONFIG_2)    ; load addr
        LDI32   r1, ADC_TSC_STEPCONFIG_2_MASK           ;
        SBBO    &r1, r0, 0, 4                           ; Escribir en registro
;        LBBO    &r2, r0, 0, 4                           ; Debug

; Step 2 SampleDelay-OpenDelay
        LDI32   r0, (ADC_TSC | ADC_TSC_STEPDELAY_2)     ; load addr
        LDI32   r1, ADC_TSC_STEPDELAY_2_MASK            ;
        SBBO    &r1, r0, 0, 4                           ; Escribir en registro
;        LBBO    &r2, r0, 0, 4                          ; Debug

; Step 3 config Importante STEPCONFIG_PROTECT debe ser SET para configurar STEP
...
; Step 4 config Importante STEPCONFIG_PROTECT debe ser SET para configurar STEP
...
GET_SAMPLE_LOOP_FOR_START:
	...
	SBBO    &r4, r5, r2, 4  			; write to ram[0] memory. La primer pasada guarda en ram[3] y la ultima en ram[0]
