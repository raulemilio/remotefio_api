...
#define ERR_SAMPLES_OUT_OF_RANGE        "Error: The value of 'samples' (%d) is out of the allowed range\n"
#define ERR_MODE_OUT_OF_RANGE           "Error: The value of 'mode' (%d) is out of the allowed range (0-2)\n"
#define ERR_INVALID_SAMPLE_RATE         "Error: The 'sample_rate' field does not exist or is not a number\n"
#define ERR_SAMPLE_RATE_OUT_OF_RANGE    "Error: The value of 'sample_rate' (%d) is out of the allowed range\n"
...
#define ADC_SAMPLES_MIN 		1
#define ADC_SAMPLES_MAX 		10000 // samples
#define ADC_FS_MIN 			10    // S/s
#define ADC_FS_MAX 			10000 // S/s
