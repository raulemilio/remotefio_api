...
#include <stdint.h>  // Include this for uint8_t type
// pines
// SDA P9_20
// SCL  P9_19

//Device parameters
#define BUS       2//Ver tabla 8-1 del libro
#define I2C_ADDR  0x27 //I2C device address (default 0x27) //
...
#define RS 0b00000001  //P0 - PCF8574T Pin connected to RS of LCD, Register Select, 1 for data register operations, 0 for instrunction register $
#define RW 0b00000010  //P1 - PCF8574T Pin connected to RW of LCD, Read/Write, 1 for read operation, 0 for write operations, this lib doesn't im$
