...
//ADC
#define ERR_ADC_INVALID_SAMPLES             "Err: samples    "
#define ERR_ADC_MODE_OUT_OF_RANGE           "Err: mode range "
#define ERR_ADC_SAMPLE_RATE_OUT_OF_RANGE    "Err: rate range "
#define ERR_ADC_BUFFER_SIZE_OUT_OF_RANGE    "Err: buffer size"
#define ERR_ADC_NUM_SAMPLES_OUT_OF_RANGE    "Err: samples num"
#define ERR_ADC_INVALID_TRIGGER             "Err: trigger val"
#define ERR_ADC_INVALID_SAMPLE_PERIOD       "Err: period val "
...
#define JSON_KEY_ADC_NUM_SAMPLES            "num_samples"
#define JSON_KEY_ADC_BUFFER_SIZE            "buffer_size"
#define JSON_KEY_ADC_ENABLE_TRIGGER         "enable_external_trigger"
#define JSON_KEY_ADC_SAMPLE_PERIOD          "sample_period"

#define JSON_KEY_ADC_STATE                  "state"
#define JSON_KEY_ADC_SAMPLES                "samples"
#define JSON_KEY_ADC_SAMPLE_RATE            "sample_rate"
