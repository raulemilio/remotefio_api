...
;* Date/Time created: Wed Apr  2 12:57:47 2025                                *
;******************************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	...
	.dwattr $C$DW$CU, DW_AT_comp_dir("/home/debian/remotefio_api/test_mem_adc_4c/pru_firmware")
...
;	/usr/bin/optpru /tmp/TI0mseZUsZQ /tmp/TI0msKkhsNx 
;	/usr/bin/acpiapru -@/tmp/TI0msDgAgC2 
	.sect	".text:main"
	.clink
	.global	||main||
