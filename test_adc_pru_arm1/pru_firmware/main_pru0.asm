...
;* Date/Time created: Wed Feb  5 13:10:13 2025                                *
;******************************************************************************
...
$C$DW$CU	.dwtag  DW_TAG_compile_unit
	...
	.dwattr $C$DW$CU, DW_AT_comp_dir("/home/debian/remotefio_api/test_adc_pru_arm1/pru_firmware")
...
;	/usr/bin/optpru /tmp/TI0oJ8g2Bc6 /tmp/TI0oJQ1OoN2 
;	/usr/bin/acpiapru -@/tmp/TI0oJakhwEl 
	.sect	".text:main"
	.clink
	.global	||main||
...
$C$DW$4	.dwtag  DW_TAG_subprogram
	...
	.dwpsn	file "src/main_pru0.c",line 48,column 1,is_stmt,address ||main||,isa 0
...
;* r0_0  assigned to $O$C1
	...
	.dwcfi	cfa_offset, 2
	.dwpsn	file "src/main_pru0.c",line 50,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
	...
	.dwpsn	file "src/main_pru0.c",line 54,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
...
;----------------------------------------------------------------------
	...
	.dwpsn	file "src/main_pru0.c",line 56,column 2,is_stmt,isa 0
;----------------------------------------------------------------------
;  56 | start();                                                               
;----------------------------------------------------------------------
