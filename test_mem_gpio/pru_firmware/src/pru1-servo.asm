...
start:
; Memory write
        LDI32   r0, data0       ; Load the value of data0 into r0
        LDI32   r1, ram0_addr   ; Load the RAM address (ram0) into r1
        SBBO    &r0, r1, 0, 4   ; Store the value of r0 at ram0[0]
; Memory read
        LDI32   r1, ram0_addr   ; Load the RAM address (ram0) into r1
        LBBO    &r2, r1, 0, 4   ; Load 4 bytes from ram0[0] into r2
